...
(()=>{
  ...
  window.KEYSUITE_BUILD='V4.27.04';
  const VERSION='42704';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.27.04';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.27.04':'V4.27.04'});document.documentElement.setAttribute('data-keysuite-version','4.27.04')}catch(_){} }
  (async()=>{
