...
(()=>{
  ...
  window.KEYSUITE_VERSION='4.27.14';
  window.KEYSUITE_BUILD='V4.27.14';
  const VERSION='42714';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.27.14';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.27.14':'V4.27.14'});document.documentElement.setAttribute('data-keysuite-version','4.27.14')}catch(_){} }
  (async()=>{
    ...
    try{window.dispatchEvent(new CustomEvent('KEYSUITE_V41300_RUNTIME_READY',{detail:{version:'4.27.14'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_RUNTIME_READY',{detail:{version:'4.27.14'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_BRAND_RECOVERY'))}catch(_){ }
  })();
})();
