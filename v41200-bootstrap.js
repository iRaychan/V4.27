...
(()=>{
  ...
  window.KEYSUITE_BUILD='V4.27.05';
  const VERSION='42705';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.27.05';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.27.05':'V4.27.05'});document.documentElement.setAttribute('data-keysuite-version','4.27.05')}catch(_){} }
  (async()=>{
